using Dapper;
using TopupPortal.Application.Common.Models.Identity;
...
namespace TopupPortal.Infrastructure.Identity
{
    public class CustomUserStore : IUserStore<ApplicationUser>, IUserPasswordStore<ApplicationUser>, IDisposable
    {
        ...
        public CustomUserStore(IDbConnectionFactory dbConnection)
        {
            _dbConnection = dbConnection;
           // _passwordHasher = passwordHasher;
            _dbConnection.ConnectionString = "test";
